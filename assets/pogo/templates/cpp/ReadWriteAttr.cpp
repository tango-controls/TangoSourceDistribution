...
//
//-----------------------------------------------------------------------------
void TemplateDevServ::read_attr_hardware(std::vector<long> &attr_list)
{
...
void TemplateDevServ::read_attr(Tango::Attribute &attr)
{
	...
	DEBUG_STREAM << "In read_attr for attribute " << attr_name << std::endl;
...
//
//-----------------------------------------------------------------------------
void TemplateDevServ::write_attr_hardware(std::vector<long> &attr_list)
{
	DEBUG_STREAM << "In write_attr_hardware for " << attr_list.size();
	DEBUG_STREAM << " attribute(s)" << std::endl;
